...
test("pack one file with source file field and existing sourcemap", function(t) {
  ...
  p.on("end", function() {
    ...
    t.equal(
      fstMap.generated.column,
      fstFooMap.generated.column,
      "first generated columns are same"
    );
    t.equal(
      lstMap.generated.column,
      lstFooMap.generated.column,
      "last generated columns are same"
    );

    t.equal(
      fstMap.generated.line,
      fstFooMap.generated.line + 1,
      "first generated line is offset by 1"
    );
    t.equal(
      lstMap.generated.line,
      lstFooMap.generated.line + 1,
